	...
	$('.pp').hover(function(){
		...
		$('.dl').click(function(){
			...
			if(num==""){
				...
				$('input').css('border','1px solid #ABB0B3')
				$('.ts').hide()
				$('.dlcg').animate(500).slideDown()
			}
			})
			
			$('button').hover(function(){
				$(this).css({'background':'#fff','border':'1px solid black'})
				$(this).find('span').css('color','#003150')
				$(this).find('p').css('color','#003150')
				},function(){
				$(this).css({'background':'#003150','border':'0px solid black'})
